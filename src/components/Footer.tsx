      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex gap-3">
            {[
              { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>, label: 'Instagram', href: 'https://www.instagram.com/gokul_sjg47/' },
              ...
              { icon: <MessageCircle size={18} />, label: 'WhatsApp', href: 'https://wa.me/918610866523' },
            ].map(({ icon, label, href }) => (
              <a
                key={label}
                href={href}
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-sm text-white/60">
              ...
              <span>+91 8610866523</span>
            </li>
            <li className="flex items-start gap-3 text-sm text-white/60">
              <Mail size={16} className="text-sage-light mt-0.5 shrink-0" />
              <span>santhosh20060911@gmail.com</span>
            </li>
            <li className="flex items-start gap-3 text-sm text-white/60">
